...
| 文件 | 职责 |
|---|---|
| `flydeer-struct-mind-common/.../ErrorCodes.java` | 错误码常量 |
| `flydeer-struct-mind-common/.../exception/**` | 异常类与默认文案 |
| `flydeer-struct-mind-controller/.../GlobalExceptionHandler.java` | HTTP 状态与 `ApiResult.fail` 组装 |
| `flydeer-struct-mind-contract/.../ApiResult.java` | 统一响应信封 |
