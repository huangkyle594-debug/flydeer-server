...
3. 按 DB 中的 `verified` 等与 `UserLevelEnum` 比对
...
| 层 | 类 |
|---|---|
| contract | `UserLevelEnum`、`LoginChannelEnum`、`ApiRequest`、Auth/User/Delegate DTO、`AuthorizationApi`/`UserMangeApi`/`DelegateApi` |
