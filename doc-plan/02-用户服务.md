...
| 层 | 类 |
|---|---|
| contract | `AuthRequiredLevel`、`LoginChannelEnum`、`ApiRequest`、Auth/User/Delegate DTO、`AuthorizationApiImpl`/`UserMangeApiImpl`/`DelegateApi` |
| repository | `UserEntity`、`UserDelegateEntity`、`UserMapper`、`UserDelegateMapper` + XML |
| service | `JwtTokenUtils`、`IdGenerateUtils`（随机步长）、`SmsVerifyService`、`OauthService`、`UserMangeApiImpl`、`UserDelegateApiImpl`、Properties、`RateLimitUtils` |
